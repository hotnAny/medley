...
MEDLEY.ROUGHLAYERHEIGHT = 2;
MEDLEY.MINNUMBOUNDINGLAYERS = 8;
MEDLEY.YUP = new THREE.Vector3(0, 1, 0);
MEDLEY.STEPUNBENDSEARCH = 30 * Math.PI / 180;
...
MEDLEY.WIDTHDIALOG = 450;
MEDLEY.HEIGHTDIALOG = 520;
MEDLEY.WIDTHDIALOGTHUMBNAIL = 80;
